...
@synthesize pageViewClickedBlock;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        tap=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(itemClicked:)];
...
-(void)itemClicked:(id)btn
{
//    CCPlayViewController *playController=[[CCPlayViewController alloc] init];
//    playController.playUrl = [[self.dataSource objectAtIndex:_currentPage ] objectForKey:@"url"];
//    playController.playName = @"详细";
//    pageViewClickedBlock(playController);
}
