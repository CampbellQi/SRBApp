...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([self.delegate respondsToSelector:@selector(highlightWordContainingCharacterAtIndex:)]) {
        [self.delegate highlightWordContainingCharacterAtIndex:index];
    }
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    //UITouch *touch = [touches anyObject];
    //CFIndex index = [self characterIndexAtPoint:[touch locationInView:self]];
    if ([self.delegate respondsToSelector:@selector(removeHighlight)]) {
        [self.delegate removeHighlight];
    }
    if ([self.delegate respondsToSelector:@selector(clickedTextClicked:)]) {
        [self.delegate clickedTextClicked:self.clickedText];
    }
