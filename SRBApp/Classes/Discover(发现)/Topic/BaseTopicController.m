...
- (void)viewDidLoad {
    ...
    UINib *nib = [UINib nibWithNibName:@"TopicListCell" bundle:[NSBundle mainBundle]];
    [self.tableView registerNib:nib forCellReuseIdentifier:@"TopicListCell"];
}
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!model.model_description || model.model_description.length == 0) {
        cellHeight -= 47;
    }
    return cellHeight + [cell.markView fittedSize].height - 24.0;
}
