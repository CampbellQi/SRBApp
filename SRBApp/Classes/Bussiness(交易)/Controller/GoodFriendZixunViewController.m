//
//  GoodFriendZixunViewController.m
//  SRBApp
//
...
@interface GoodFriendZixunViewController ()<UITableViewDataSource,UITableViewDelegate,HPGrowingTextViewDelegate,UIScrollViewDelegate>

@end

@implementation GoodFriendZixunViewController
{
...
{
    //拼接post参数
    NSDictionary * dic = [self parametersForDic:@"getPostCommentsByRelation" parameters:@{ACCOUNT_PASSWORD, @"isFriended":@"1",@"id":self.idNumber,@"start":@"0", @"count":[NSString stringWithFormat:@"%d",NumOfItemsForZuji]}];
...
- (void)footerRefresh
{
    ...
    //拼接post参数
    NSDictionary * dic = [self parametersForDic:@"getPostCommentsByRelation" parameters:@{ACCOUNT_PASSWORD, @"isFriended":@"1",@"id":self.idNumber,@"start":[NSString stringWithFormat:@"%d",page], @"count":[NSString stringWithFormat:@"%d",NumOfItemsForZuji]}];
