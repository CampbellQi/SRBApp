...
@interface FreeSaleViewController ()<UITextViewDelegate, UITextFieldDelegate,CTAssetsPickerControllerDelegate,ISSShareViewDelegate,TuSDKPFCameraDelegate, TuSDKPFEditTurnAndCutDelegate, TuSDKFilterManagerDelegate>
{
...
@implementation FreeSaleViewController
...
- (void)setMainView
{
    ...
    [self.publishLater.shareButton addTarget:self action:@selector(shareButton:) forControlEvents:UIControlEventTouchUpInside];
}
...
- (void)setTheView
{
    ...
    UIView * view4 = [[UIView alloc]initWithFrame:CGRectMake(0, viewtype.frame.origin.y + viewtype.frame.size.height + 20, SCREEN_WIDTH, 100)];
...
//    _scrollView.contentSize = CGSizeMake(SCREEN_WIDTH, button.frame.origin.y + button.frame.size.height + 10);
...
//    }
    ...
    if (_model.sortid == nil) {
        ...
        if ([positionsign isEqualToString:@"1"]) {
            ...
            NSDictionary * dic = [self parametersForDic:@"accountCreatePost" parameters:@{ACCOUNT_PASSWORD, @"dealType":@"1", @"originalPrice":@"0", @"relationPrice":@"0", @"transportPrice":postPrice.text, @"xyz":xyz, @"position":position, @"city":_city, @"positionView":@"1", @"photos":theStr, @"title":titleTT.text, @"content":detailTV.text, @"storage":howMany.text, @"guaranteeAllow":@"0", @"guaranteePrice":price, @"uuid":@"0", @"categoryID":_categoryID, @"freeShipment":postNumber,@"share":isShareToLocation}];
...
//                [self.navigationController pushViewController:vc animated:YES];
        ...
        NSDictionary * dic = [self parametersForDic:@"accountUpdatePost" parameters:@{ACCOUNT_PASSWORD,@"id":_model.model_id, @"dealType":@"1",@"xyz":@"0",@"position":@"0",@"photos":theStr, @"title":titleTT.text, @"content":detailTV.text, @"guaranteeAllow":@"0", @"guaranteePrice":price,@"uuid":@"0",@"transportPrice":postPrice.text,@"storage":howMany.text,@"categoryID":_categoryID,@"freeShipment":postNumber}];
