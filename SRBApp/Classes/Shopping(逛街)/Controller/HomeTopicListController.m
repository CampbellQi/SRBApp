...
#define HEADERSECTIONVIEW_HEIGHT 148
...
-(void)addTableHeaderView {
    HomeTopicListHeaderView *header = [[HomeTopicListHeaderView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 1) CarouselArray:_carsouselArray BussinessModel:_dailyTopicBussinessModel];
    //标签点击
    ...
    [header.cv addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(goTopicDetailVC)]];
...
-(void)goTopicDetailVC {
    ...
    detail.backBlock = ^(void) {
        ...
        header.sourceModel = _dailyTopicBussinessModel;
    };
    detail.sourceModal = _dailyTopicBussinessModel;
