...
//    submitBtn.frame = CGRectMake(160 - 15 - 60, 32.5, 60, 25);
//    [mainScroll addSubview:submitBtn];
    
//    UIView * lineView = [[UIView alloc]initWithFrame:CGRectMake(0, submitBtn.frame.size.height + submitBtn.frame.origin.y + 12.5, 160, 1)];
...
//- (void)bottomBtnLong:(UILongPressGestureRecognizer *)longPress
//{
//    if (longPress.state == UIGestureRecognizerStateBegan) {
//        UIButton * tempBtn = (UIButton *)longPress.view;
//        [self changeDealType:tempBtn];
//        [self submit:tempBtn];
//    }
//}
//
...
{
    //    NSInteger oldIndex = topOldIndex;
    //    if (oldIndex == 0) {
    //        oldIndex += 1000;
    //    }else{
    //        oldIndex = topOldIndex;
    //    }
...
- (void)submit
{
    ...
    self.shoppingVC.shopRelationTVC.saleAndBuyType = [NSString stringWithFormat:@"%d",topOldIndex-1000];
    self.shoppingVC.shopRelationTVC.categoryID = categoryIDStr;
    self.shoppingVC.shopRelationTVC.groupID = friendGroupIDStr;
    
    self.shoppingVC.shopCircleTVC.categoryID = categoryIDStr;
    self.shoppingVC.shopCircleTVC.saleAndBuyType = [NSString stringWithFormat:@"%d",topOldIndex-1000];
    self.shoppingVC.shopCircleTVC.groupID = friendGroupIDStr;
    ...
    [self.shoppingVC.shopCircleTVC.dataArray removeAllObjects];
    [self.shoppingVC.shopRelationTVC.dataArray removeAllObjects];
    [self.shoppingVC.shopCircleTVC.tabelView reloadData];
    [self.shoppingVC.shopRelationTVC.tabelView reloadData];
    [self.shoppingVC.shopRelationTVC start];
    [self.shoppingVC.shopCircleTVC start];
    
    [self.shoppingVC.shopCircleTVC urlRequestPost];
    [self.shoppingVC.shopRelationTVC urlRequestPost];
}
