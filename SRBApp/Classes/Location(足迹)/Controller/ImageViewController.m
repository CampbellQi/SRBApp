...
//    }
    ...
    self.imageArray = [NSMutableArray arrayWithArray:[self.imageUrl componentsSeparatedByString:@","]];
...
//    }
    ...
    self.pageLabel.text = [NSString stringWithFormat:@"%.0f/%lu",_scrollView.contentOffset.x/SCREEN_WIDTH+1,(unsigned long)self.tempArr.count];
...
//            UIImageWriteToSavedPhotosAlbum([imgArr objectAtIndex:page - 1], nil, nil, nil);
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    self.pageLabel.text = [NSString stringWithFormat:@"%.0f/%lu",self.scrollView.contentOffset.x/SCREEN_WIDTH+1,(unsigned long)self.tempArr.count];
