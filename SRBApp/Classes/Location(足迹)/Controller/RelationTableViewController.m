...
@interface RelationTableViewController ()<TableViewCellDelegates>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"cell.locationModel == %@",cell.locationModel.ID);
    return cell;
}
...
- (void)urlRequestPost
{
    ...
    NSDictionary * dic;
        ...
        dic = [self parametersForDic:@"getDynamicLocationByRelation" parameters:@{@"account":name,@"password":pass,@"start":@"0",@"count":@"20"}];
