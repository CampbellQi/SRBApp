...
//    _scrollView.contentSize = CGSizeMake(SCREEN_WIDTH - 30, SCREEN_HEIGHT * 1.3);
    ...
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 30, 140, 18)];
    ...
    _scrollView.contentSize = CGSizeMake(SCREEN_WIDTH - 30, 26 + _helpLabel.frame.size.height);
    [self post];
}
...
{
    //拼接post参数
    NSDictionary * dic = [self parametersForDic:@"getSystemInfo" parameters:@{@"type":@"1"}];
    //发送post请求
