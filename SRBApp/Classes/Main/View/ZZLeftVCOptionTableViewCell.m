...
@implementation ZZLeftVCOptionTableViewCell
...

{
    ...
    if (self) {
        ...
        _whiteLine = [[UILabel alloc]initWithFrame:CGRectMake(45, 0, 200, 1)];
        _whiteLine.backgroundColor = [UIColor whiteColor];
        [self.contentView addSubview:_whiteLine];
