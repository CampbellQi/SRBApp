...
{
    NSString * tempStr = [NSString stringWithFormat:@"%@\n%@",[tempException reason],[[tempException userInfo] objectForKey:UncaughtExceptionHandlerAddressesKey]];
    NSDictionary * dic = [self parametersForDic:@"addInfoBack" parameters:@{ACCOUNT_PASSWORD,@"title":@"iOS_Crash",@"msg":tempStr}];
