...
#define kTipColorError [UIColor whiteColor]
...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = [UIColor colorWithRed:229/255.0 green:0 blue:93/255.0 alpha:0.9];
...
//                    ZZNavigationController *nac = [[ZZNavigationController alloc]initWithRootViewController:loginVC];
