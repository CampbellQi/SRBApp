...
#define kLLLineColor [UIColor colorWithRed:255.0/255.0 green:187.0/255.0 blue:30.0/255.0 alpha:0.8] // 线条色金
#define kLLLineColorWrong [UIColor colorWithRed:237.0/255.0 green:80.0/255.0 blue:36.0/255.0 alpha:0.8] // 线条色红
...
//        LLLog(@"每个圆点位置 %d,%d", x, y);
        [button setFrame:CGRectMake(x, y + 32, kCircleDiameter, kCircleDiameter)];
        
        [button setBackgroundColor:[UIColor clearColor]];
        [button setBackgroundImage:[UIImage imageNamed:@"gesture_pattern_item_bg.9"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"gesture_pattern_selected 11-11-40-074"] forState:UIControlStateSelected];
...
- (void)showErrorCircles:(NSString*)string
{
    ...
    for (UIButton* button in buttonArray) {
        if (button.selected) {
            [button setBackgroundImage:[UIImage imageNamed:@"gesture_pattern_selected_wrong 11-11-40-080"] forState:UIControlStateSelected];
        }
